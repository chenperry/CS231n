...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W2'] = np.random.randn((H // pool_stride) * (W // pool_stride) * num_filters, hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dpool = max_pool_backward_naive(dconv_relu_pool_out, pool_cache)
        drelu = relu_backward(dpool, relu_cache)
        dx, dW1, db1 = conv_backward_naive(drelu, conv_cache)
